...
**Nouveau :** deux lignes ont été ajoutées — "Type de véhicule" et "Supplément" — pour que le client voie clairement ce qu'il a choisi en plus (SUV, Van, traitement cuir, poils d'animaux…). Si le client n'a rien pris en supplément, ces lignes s'afficheront simplement vides ou avec "Inclus" selon le véhicule — rien de grave, pas besoin d'ajuster.
...
Date : {{date}}
Heure : {{heure}}
Type de véhicule : {{vehicule_type}}
Supplément : {{options}}
