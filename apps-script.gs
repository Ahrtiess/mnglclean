...
// Si de nouvelles colonnes sont ajoutées à HEADERS plus tard et que la
// feuille existe déjà avec l'ancien format, cette fonction insère
// automatiquement la colonne manquante au bon endroit — sans jamais
// toucher aux données déjà présentes.
